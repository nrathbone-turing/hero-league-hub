...
// - Dual-db upgrade (main + test) for local dev
...
// ✅ Dual upgrade (main + test) for local; single for docker
const dbUpgrade = () => {
  if (MODE === "LOCAL") {
...
const dbSeed = () => {
  if (MODE === "LOCAL") {
    ...
    // Use Python module invocation so FlaskGroup registers properly
